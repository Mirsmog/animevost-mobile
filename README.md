...
Неофициальный Android-клиент для сайта [animevost.info](https://animevost.info). Приложение позволяет смотреть аниме, следить за расписанием выхода серий и управлять избранным.
...
- Авторизация через аккаунт animevost.info
...
> Для входа в приложение нужен существующий аккаунт на [animevost.info](https://animevost.info). Регистрация через приложение пока не поддерживается.
